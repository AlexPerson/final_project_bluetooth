...
-(void)tLog:(NSString *)msg
{
    ...
    self.textview.text = [msg stringByAppendingString:self.textview.text];
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    NSString * message = @"Scanning stopped";
    [self tLog: message];
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error
{
    ...
    for (CBService *service in peripheral.services) {
        NSLog(@"Start to look for characteristics");
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverCharacteristicsForService:(CBService *)service error:(NSError *)error
{
    ...
    for (CBCharacteristic *characteristic in service.characteristics) {
        ...
        if ([characteristic.UUID isEqual:[CBUUID UUIDWithString:TRANSFER_CHARACTERISTIC_UUID]]) {
            ...
            NSLog(@"set characteristic notification to YES");
        }
    }
